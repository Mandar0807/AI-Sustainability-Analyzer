...
def save_to_dataset(prompt: str, result: dict):
    ...
    cursor.execute('''
        INSERT INTO comparison_dataset (
            ...
            groq_tokens, groq_energy, groq_co2,
            groq_response_time, groq_success,
            cohere_tokens, cohere_energy, cohere_co2,
            cohere_response_time, cohere_success,
            mistral_tokens, mistral_energy, mistral_co2,
            mistral_response_time, mistral_success,
            openrouter_tokens, openrouter_energy, openrouter_co2,
            openrouter_response_time, openrouter_success,
            huggingface_tokens, huggingface_energy, huggingface_co2,
            huggingface_response_time, huggingface_success,
    ...
    ''', (
        ...
        get_val("groq", "total_tokens"),
        get_val("groq", "energy_kwh"),
        get_val("groq", "co2_grams"),
        get_val("groq", "response_time"),
        1 if model_data.get("groq", {}).get("success") else 0,
        get_val("cohere", "total_tokens"),
        get_val("cohere", "energy_kwh"),
        get_val("cohere", "co2_grams"),
        get_val("cohere", "response_time"),
        1 if model_data.get("cohere", {}).get("success") else 0,
        get_val("mistral", "total_tokens"),
        get_val("mistral", "energy_kwh"),
        get_val("mistral", "co2_grams"),
        get_val("mistral", "response_time"),
        1 if model_data.get("mistral", {}).get("success") else 0,
        get_val("openrouter", "total_tokens"),
        get_val("openrouter", "energy_kwh"),
        get_val("openrouter", "co2_grams"),
        get_val("openrouter", "response_time"),
        1 if model_data.get("openrouter", {}).get("success") else 0,
        get_val("huggingface", "total_tokens"),
        get_val("huggingface", "energy_kwh"),
        get_val("huggingface", "co2_grams"),
        get_val("huggingface", "response_time"),
    ...
    conn.commit()
    conn.close()
    print(f"[COMPARE] Saved to dataset")